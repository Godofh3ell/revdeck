    ...
    <div class="images">
        <div class="woo-variation-gallery-wrapper">
			...
			if ( has_post_thumbnail() ) {
				...
				if ( $attachment_count > 0 && !isset($check) ) {
				...
				echo '<figure class="woocommerce-product-gallery__image--placeholder">' . apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'streamvid' ) ), $post->ID ) . '</figure>';
