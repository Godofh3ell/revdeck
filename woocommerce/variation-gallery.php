...
if ( ! function_exists( 'jws_vg_admin_html' ) ) {
	function jws_vg_admin_html( $loop, $variation_data, $variation ) {
		...
		echo '<div class="jws-variation-gallery-wrapper">';
			echo '<h4>' . esc_html__( 'Variation Image Gallery', 'streamvid' ) . '</h4>';
			...
			echo '<a href="#" class="button jws-add-variation-gallery-image">' . esc_html__( 'Add Gallery Images', 'streamvid' ) . '</a>';
		echo '</div>';
	}
...
function jws_add_points_field_to_variations( $loop, $variation_data, $variation ) {
    ...
    for ($i = 1; $i <= 100; $i++) {
     ...
     woocommerce_wp_select( array(
        'id' => '_box_points[' . $loop . ']',
        'label'   => __( 'Choose points for product', 'streamvid' ),
