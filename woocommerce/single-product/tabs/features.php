<?php 
    ...
    if(!empty($content) && !is_wp_error($content)) { ?> 
        <div class="f-include">
            <div class="left"><?php echo esc_html__('Include','streamvid'); ?></div>
            <div class="right">
                <?php 
                    if(!empty($content)) {
                         $include = array();   
                        ...
                        echo '<span>'.esc_html__('not found','streamvid').'</span>';
                    }   
        ...
        ?>
        <div class="f-exclude">
            <div class="left"><?php echo esc_html__('Exclude','streamvid'); ?></div>
            <div class="right">
                <?php 
