...
class Video_popup extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Video Popup', 'streamvid' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
				...
				[
					...
					'default'   => 'overlay',
					'options'   => [
                        'overlay'   => esc_html__( 'Overlay', 'streamvid' ),
						'border_ani'   => esc_html__( 'Border Animation', 'streamvid' ),
                        'border'   => esc_html__( 'Border', 'streamvid' ),
					],
				]
		);
        $this->add_control(
        ...
        $this->add_control(
			'url',
			[
				'label' => esc_html__( 'URl Video', 'streamvid' ),
				'type' =>  Controls_Manager::TEXT,
				'default' => esc_html__( 'https://www.youtube.com/watch?v=JtVd7q25FDA', 'streamvid' ),
			]
        ...
        $this->add_control(
			'icon_type',
			[
				'label' => esc_html__( 'Icon Background Type', 'streamvid' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'classic'    => [
        ...
        $this->add_control(
					'icon_bgcolor2',
					[
						'label' 	=> esc_html__( 'Icon Background Overlay Color', 'streamvid' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Icon Border Color', 'streamvid' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Icon Border Color Animation', 'streamvid' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
							'{{WRAPPER}} .jws_video_popup.video-border .jws_video_popup_inner a:before' => 'border-color: {{VALUE}};',
