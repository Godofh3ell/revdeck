...
class Menu_Cart extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Mini cart', 'streamvid' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Menu Icon', 'streamvid' ),
			]
		);
        ...
        $this->add_control(
			'show_count',
			[
				'label' => esc_html__( 'Show Count', 'streamvid' ),
        ...
        $this->add_control(
			'show_price',
			[
				'label' => esc_html__( 'Show Price', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'streamvid' ),
				'label_off' => esc_html__( 'Off', 'streamvid' ),
				'return_value' => 'yes',
		...
		$this->start_controls_tab( 'toggle_button_normal_colors', [ 'label' => esc_html__( 'Normal', 'streamvid' ) ] );
		...
		$this->start_controls_tab( 'toggle_button_hover_colors', [ 'label' => esc_html__( 'Hover', 'streamvid' ) ] );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Size (Width and Height)', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Count', 'streamvid' ),
				'separator' => 'before',
			]
		);
        $this->add_control(
			'count_color',
			[
				'label' => esc_html__( 'Count Color', 'streamvid' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'count_bgcolor',
			[
				'label' => esc_html__( 'Count Background', 'streamvid' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'count_wh',
			[
				'label' => esc_html__( 'Count Width,Height', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 10,
        ...
        $this->add_control(
			'count_x',
			[
				'label' => esc_html__( 'X position', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->add_control(
			'count_y',
			[
				'label' => esc_html__( 'Y position', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
	   ...
	   $this->start_controls_section(
			'section_style_emtry',
			[
				'label' => esc_html__( 'Content Emtry', 'streamvid' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
