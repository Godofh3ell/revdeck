...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <header>
                  <div class="post-media<?php if(!has_post_thumbnail()) echo esc_attr(' post-no-thumbnail'); ?>">
                       <div class="post-media_inner<?php if(!empty($gallery)) echo esc_attr(' post-image-slider'); ?>">
                        <?php 
                ...
                <div class="jws-post-info">
                    ...
                    <span class="post_author"><?php echo '<a href="'.get_author_posts_url( get_the_author_meta( 'ID' ) ).'">'.get_avatar( get_the_author_meta( 'ID' ), 40 ).'<span>'.esc_html__('by ','streamvid').'</span>'.get_the_author(); ?></a></span> 
                    <a href="<?php echo get_the_permalink().'#comments'; ?>" class="entry-comment"><span class="jws-comment"></span><?php echo sprintf( _n( '%s comment', '%s comments', $comments_number, 'streamvid' ), $comments_number );; ?></span></a>
                </div>
           ...
           <footer>
                ...
                <div class="post-related jws-blog-element">
                    <h3><?php esc_html_e('Related Post','streamvid'); ?></h3>
