                        ...
                        if(!empty($prev_post)){    
                            ...
                            echo '<div class="left">
                                   <div class="content_nav">
                                        <span class="fs-small cl-body2"><i class="jws-icon-caret-left"></i>'.esc_html__('Previous Post','streamvid').'</span>
                                        <h6 class="title">
                                ...
                                echo '<div class="left">
                                   <div class="content_nav">
                                        <span class="fs-small cl-body2">'.esc_html__('Previous Post','streamvid').'<i class="jws-icon-caret-left"></i></span>
                                        <h6 class="title">
                            ...
                            if(!empty($next_post)){
                                   ...
                                   echo '<div class="right">
                                            ...
                                            <div class="content_nav">
                                               <span class="fs-small cl-body2">'.esc_html__('Next Post','streamvid').'<i class="jws-icon-caret-right"></i></span> 
                                               <h6 class="title">
