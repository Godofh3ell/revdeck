...
<div class="jws-user-private-sidebar">
    ...
    <div class="clearfix jws-user-top">
        ...
        <div class="jws-user-profile-information">
            ...
            <div class="title-sub"><?php esc_html_e('Private Seller', 'streamvid'); ?></div>
    ...
    <div class="jws-actions-list heading-font">
        ...
        <a
            ...
            <i class="fa fa-car"></i><?php esc_html_e('My Inventory', 'streamvid') ?>
        </a>

        <a
            href="<?php echo esc_url(add_query_arg(array('page_admin' => 'settings'), jws_get_author_link(''))); ?>">
            <i class="fa fa-cog"></i>
            <?php esc_html_e('Profile Settings', 'streamvid') ?>
        </a>
    ...
    <?php if (!empty($user_fields['phone'])): ?>
        <div class="jws-dealer-phone">
            ...
            <div
                class="phone-label heading-font"><?php esc_html_e('Seller Contact Phone', 'streamvid'); ?></div>
    ...
    <div class="jws-dealer-mail">
        ...
        <div class="mail-label heading-font"><?php esc_html_e('Seller Email', 'streamvid'); ?></div>
    ...
    <div class="show-my-profile">
        <a href="<?php echo esc_url(jws_get_author_link('myself-view')); ?>" target="_blank"><i
                class="fa fa-external-link"></i><?php esc_html_e('Show my Public Profile', 'streamvid'); ?>
        </a>
    </div>
